        ...
        <article className="container-content">
          ...
          <CaseStudySection title="Design Approach">
            ...
            <div className="mt-6 divide-y divide-border border-y border-border">
              {[
                [
                  "Research and accessibility framing",
                ...
                [
                  "Examining assumptions in existing tools",
                ...
                [
                  "Designing to reduce interaction barriers",
                ...
                [
                  "Multimodal prototyping and implementation",
          ...
          <CaseStudySection title="Auditing Existing Tools">
            ...
            <ul className="space-y-2 mt-2">
              ...
              <li>
                • <strong>Design Implication 6: Support more than one pathway:</strong>{" "}
