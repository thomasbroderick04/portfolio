...
const MindSpark = () => {return (← Back to projects
        ...
        <div className="mt-6 divide-y divide-border border-y border-border">
          {[
            [
              ...
              "Increased text clarity, improved spacing, strengthened hierarchy, and broke the testing experience into clearer stages.",
            ],
            [
              "Navigation needed to feel familiar",
              "Users expected clearer back arrows and standard mobile patterns.",
              "Aligned the interface more closely with best-practice mobile conventions so users did not have to relearn how to move through the system.",
            ],
            [
              "The main test interaction needed stronger affordance",
              "Users wished for the primary ‘Go’ button used to take the test to be more clearly distinctive as a button",
              "Ensured successive iterations improved button styling, states, and clarity.",
            ],
            [
              ...
              "Strengthened the demonstration and practice stages so users could understand the rules before the official assessment started.",
            ],
            [
              "Feedback needed to stay calm and supportive",
              "Harsh error cues created pressure, and so corrective feedback was softened.",
              "Softened corrective feedback so errors felt informative rather than discouraging during practice and testing.",
            ],
            [
              "Microphone use needed clearer onboarding",
              "This led directly to the microphone enclosure and stand system.",
              "Developed the microphone enclosure and stand system so the verbal pathway could be tested as a more deliberate and comfortable interaction setup.",
            ],
            [
              ...
              "Refined the results screens so users could understand their score through response breakdowns, alertness information, progress views, and performance classification.",
            ],
          ].map(([finding, observation, response]) => (
            <div
              key={finding}
              className="grid md:grid-cols-[260px_1fr] gap-3 md:gap-8 py-5"
            >
              ...
              <div className="space-y-3">
                ...
                <div className="grid sm:grid-cols-[140px_1fr] gap-1 sm:gap-4">
